...
_WEAPON_MAP: dict[str, str] = {
    ...
    "CLERMediumLaserPrototype": "ermlas", "CLERLargeLaserPrototype": "erllas",
    "CLERSmallLaserPrototype": "erslas",
    ...
    # Mech Mortar
    "Mech Mortar 1": "mm1", "Mech Mortar 2": "mm2",
    "Mech Mortar 4": "mm4", "Mech Mortar 8": "mm8",
    "'Mech Mortar 1": "mm1", "'Mech Mortar 2": "mm2",
    "'Mech Mortar 4": "mm4", "'Mech Mortar 8": "mm8",
    "Mech Mortar-1": "mm1", "Mech Mortar-2": "mm2",
    "Mech Mortar-4": "mm4", "Mech Mortar-8": "mm8",
    "'Mech Mortar-1": "mm1", "'Mech Mortar-2": "mm2",
    "'Mech Mortar-4": "mm4", "'Mech Mortar-8": "mm8",
    "Clan Mech Mortar 1": "cmm1", "Clan Mech Mortar 2": "cmm2",
    "Clan Mech Mortar 4": "cmm4", "Clan Mech Mortar 8": "cmm8",
    "Clan 'Mech Mortar 1": "cmm1", "Clan 'Mech Mortar 2": "cmm2",
    "Clan 'Mech Mortar 4": "cmm4", "Clan 'Mech Mortar 8": "cmm8",
    "Clan Mech Mortar-1": "cmm1", "Clan Mech Mortar-2": "cmm2",
    "Clan Mech Mortar-4": "cmm4", "Clan Mech Mortar-8": "cmm8",
...
# Prototype / Improved / Rare weapon mappings
    "Prototype ER Medium Laser": "ermlas",
    "Prototype ER Small Laser": "erslas",
    "ER Large Laser Prototype": "erllas",
    "Improved Large Laser": "illas",
    "Improved Gauss Rifle": "igauss",
    "Improved SRM 6": "isrm6",
    "Improved LRM 15": "ilrm15",
    "Improved LRM 20": "ilrm20",
    "Improved Autocannon/5": "iac5",
    "Enhanced PPC": "eppc",
    "Prototype Streak SRM 4": "ssrm4",
    "Prototype Streak SRM 6": "ssrm6",
    "Prototype Rocket Launcher 20": "rl20",
    "Prototype Ultra Autocannon/10": "uac10",
    "Prototype LB 10-X Autocannon": "lbx10",
    # New / missing weapons
    "Fluid Gun": "fluidgun",
    "Light Blazer": "lblazer",
    "Bombast Laser": "bombast",
    "BattleMech Taser": "btaser",
    "Mech Taser": "mtaser",
    "Taser": "mtaser",
    "Vehicular Grenade Launcher": "vgl",
    "TSEMP Repeating Cannon": "tsempc",
    "RISC Hyper Laser": "rischl",
    "Rifle (Cannon": "h Rifle",
    "Heavy Rifle": "hrifle",
    "Mortar 8": "mm8",
    "Machine Gun Array": "mga",
    "Light Machine Gun Array": "lmga",
    "Heavy Machine Gun Array": "hmga",
    # Equipment mistakenly parsed as weapons � harmless no-ops
    "Anti-BattleArmor Pods (B-Pods)": "bpod",
    "C3 Remote Sensor Launcher": "c3remotesensor",
    "RISC Advanced Point Defense System": "riscapds",
}
...
_EQUIPMENT_MAP: dict[str, str] = {
    ...
    "Large XL Engine": "xle", "Large XXL Engine": "xxle",
    "Light Engine": "lfe",
    "XXL Engine": "xxle", "Clan XXL Engine": "cxxle",
    "Large XXL Engine": "xxle", "Large Clan XXL Engine": "cxxle",
...
_AMMO_PREFIXES: list[tuple[str, str, str]] = [
    ...
    ("Clan Rotary AC/", "ammo", "RAC"),      ("CLRotaryAC", "ammo", "RAC"),
    ("IS Ammo LRM-", "ammo", "LRM"),         ("Clan Ammo LRM-", "ammo", "CLRM"),
    ("ISLRM", "ammo", "LRM"),                ("CLLRM", "ammo", "CLRM"),
    ("IS Ammo SRM-", "ammo", "SRM"),         ("Clan Ammo SRM-", "ammo", "SRM"),
    ("ISSRM", "ammo", "SRM"),                ("CLSRM", "ammo", "CSRM"),
    ...
    # Mech Mortar ammo
    ("Clan Ammo SC Mortar-", "mm", "MM"),
    ("IS Ammo SC Mortar-", "mm", "MM"),
    ("Clan Ammo Mech Mortar-", "mm", "MM"),
    ("IS Ammo Mech Mortar-", "mm", "MM"),
    ("Clan Ammo Mortar-", "mm", "MM"),
    ("IS Ammo Mortar-", "mm", "MM"),
]
...
_ALIAS_MAP: dict[str, str] = {
    ...
    # Mech Mortar
    "ismechmortar1": "mm1", "ismechmortar2": "mm2",
    "ismechmortar4": "mm4", "ismechmortar8": "mm8",
    "clmechmortar1": "cmm1", "clmechmortar2": "cmm2",
    "clmechmortar4": "cmm4", "clmechmortar8": "cmm8",
    "ismachinegunarray": "mga",
    "islightmachinegunarray": "lmga",
    "isheavymachinegunarray": "hmga",
    "isfluidgun": "fluidgun",
    "clfluidgun": "fluidgun",
    "islightblazer": "lblazer",
    "cllightblazer": "lblazer",
    "isbombastlaser": "bombast",
    "isbattlemechtaser": "btaser",
    "ismektaser": "mtaser",
    "isvehiculargrenadelauncher": "vgl",
    "istsemprepeatingcannon": "tsempc",
    "isrischyperlaser": "rischl",
    "isimprovedlargelaser": "illas",
    "isimprovedgaussrifle": "igauss",
    "isimprovedsrm6": "isrm6",
    "isimprovedlrm15": "ilrm15",
    "isimprovedlrm20": "ilrm20",
    "isimprovedautocannon5": "iac5",
    "isenhancedppc": "eppc",
    "clenhancedppc": "eppc",
    "ismortar8": "mm8",
    "iseherppc": "erppc",
    "isgaussrifleprototype": "gauss",
    "islbxac10prototype": "lbx10",
    "ismediumpulselaserprototype": "mplas",
    "iserlargeLaserPrototype": "erllas",
    "isheavyrifle": "hrifle",
    "isriflecannon": "hrifle",
    # "1 " prefix items (equipment in weapon slots)
    "ismga": "mga",
    "clrocketlauncher15prototype": "rl15",
    "issniperartcannon": "snipercannon",
    "ischaffpod": "chaffpod",
    "issmallvibroblade": "retractable_blade",
    "issmallshield": "shield_small",
    "ismass": "mass",
    "ismediumvibroblade": "retractable_blade",
    "isremotesensordispenser": "remotesensor",
    "spikes": "spikes",
    "chainsaw": "chainsaw",
    "isc3remotesensorlauncher": "c3remotesensor",
...
_CALIBER_TO_SUBTYPE: dict[str, str] = {
    ...
    "mml": "MML", "mechmortar": "MM", "scmortar": "MM",
    "clrm": "CLRM", "csrm": "CSRM", "cssrm": "CSSRM",
    "lrt": "LRT", "srt": "SRT",
